...
import type { ListChangeEvent } from '../list/events.js';
import '../list/list-item-link.js';
import type { ListItem } from '../list/list-item.js';
import '../list/list.js';
...
if (!customElements.get('rk-command-palette')) {
  customElements.define('rk-command-palette', CommandPalette);
}
