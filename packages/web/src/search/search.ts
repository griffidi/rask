...
export class Search extends LitElement {
  ...
  override render(): TemplateResult {
    return html`
      <div class="container__wrapper">
        <label class="container">${this.renderLeadingIcon()} ${this.renderInput()} ${this.renderTrailingIcon()}</label>
      </div>
    `;
  }
  ...
  protected renderLeadingIcon(): TemplateResult {
    return html`
      <md-icon class="leading__icon">menu</md-icon>
    `;
  }

  protected renderTrailingIcon(): TemplateResult {
    return html`
      <md-icon class="trailing__icon">search</md-icon>
    `;
  }
...
if (!customElements.get('rk-search')) {
  customElements.define('rk-search', Search);
}
